    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.epoch):
            for idx in range(start_batch_id, self.num_batches):
                ...
                _, _, summary_str, d_loss = self.sess.run([self.d_optim, self.alpha_optim, self.d_sum, self.d_loss], feed_dict={self.inputs: batch_images, self.z: batch_z})
